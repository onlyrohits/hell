...
from rapida.runs import RapidaJob, RapidaNodeConfig
from rapida.runs import RapidaJob, RapidaNode, RapidaNodeConfig
from rapida.openai_async import openai, Meta
import json
COURSE_FUNCTIONS = [
    {
...
rapida_global.fail_on_error = True
rapida_global.base_url = "http://127.0.0.1:8788"
rapida_global.api_key = "sk-rapida-aizk36y-5yue2my-qmy5tza-n7x3aqa"
rapida_global.proxy_url = "http://127.0.0.1:8787/v1"


def run_creation(topic: str, create_course_outline: RapidaNode):
    ...
    _course_outline = openai.ChatCompletion.create(
        ...
        max_tokens=512,
        # headers= {
        #     "Rapida-Task-Id": create_course_outline.id,
        # }
        rapidaMeta=Meta(
