...
import * as hcone from "./RapidaOpenAITypes";
...
import { wrapAPIPromise } from "./RapidaMonkeyPatch";
import { Response } from "@whatwg-node/fetch";

export class RapidaAsyncOpenAI extends OpenAI {
  ...
  constructor(private options: IRapidaAsyncClientOptions) {
    const {
      apiKey,
      organization,
    ...
    const rapidaMeta: IRapidaMeta = {
      ...
      baseUrl: providedRapidaMeta.baseUrl ?? "https://api.hconeai.com",
    };

    options.rapidaMeta = rapidaMeta;
  ...
  private async logRequest(
    ...
    const asyncLogRequest: RapidaAsyncLogRequest = {
      ...
      timing: RapidaAsyncLogger.createTiming(startTime, endTime),
    };
